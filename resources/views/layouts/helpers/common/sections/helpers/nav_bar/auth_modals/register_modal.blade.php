<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="">
    <div class="modal-dialog">
        <div class="modal-content" style="{{'kmkz' == config('constants.DefIndexView') ? 'height: 550px;' : ''}}">
                ...
                <div class="inner_register_div" style="overflow-y: auto; overflow-x: hidden; direction: rtl;width: 96%;padding-right: 2%;padding-top: 2%">
                    <div style="">
                        <form name="modal_register_form" class="HamafzaIcon" id="modal_register_form" method="post">
                            ...
                            <div style="{{'kmkz' == config('constants.DefIndexView') ? 'height: 350px' : 'height: 350px'}};overflow: auto">
                                ...
                                @if ('kmkz' == config('constants.DefIndexView'))
                                    ...
                                    <div class="form-group input-group col-xs-12" style="margin-bottom: 0; margin-top: 12px;">
                                        ...
                                        <select name="province" id="modal_province_input" class="education_province form-control">
                                            <option value="0">انتخاب کنید</option>
                                            @if(\Session::get('provinces'))
                                                @foreach(\Session::get('provinces') as $province)
                                    ...
                                    <div id="reg_province_request_errors" class="modal_register_error_inputs" style="font-family: IranSharp; font-size: 12px; color: blue;"></div>
                                    <div class="form-group input-group" style="margin-bottom: 0; margin-top: 12px;">
                                        <span class="input-group-addon ">شهر</span>
                                        <select  id="modal_city_input" name="city" class="education_city form-control"></select>
                                        <span class="input-group-addon icon-a-b"></span>
                                    </div>
                                    <div id="reg_city_request_errors" class="modal_register_error_inputs" style="font-family: IranSharp; font-size: 12px; color: blue;"></div>
                                    <div class="form-group input-group" style="margin-bottom: 0; margin-top: 12px;">
                                        <span class="input-group-addon ">شماره همراه</span>
                                        <input type="text" class="form-control" id="modal_mobile_input" name="mobile">
                                        <span class="input-group-addon icon-a-b"></span>
                                    </div>
                                    <div id="reg_mobile_request_errors" class="modal_register_error_inputs" style="font-family: IranSharp; font-size: 12px; color: blue;"></div>
                                    <div class="form-group input-group" style="margin-bottom: 0; margin-top: 12px;">
                                        <span class="input-group-addon ">تلفن ثابت</span>
                                        <input type="text" class="form-control" id="modal_phone_input" name="phone">
                                        <span class="input-group-addon icon-a-b"></span>
                                    </div>
                                    <div id="reg_phone_request_errors" class="modal_register_error_inputs" style="font-family: IranSharp; font-size: 12px; color: blue;"></div>
                                    <div class="form-group input-group" style="margin-bottom: 0; margin-top: 12px;">
                                    ...
                                    <div id="reg_education_request_errors" class="modal_register_error_inputs" style="font-family: IranSharp; font-size: 12px; color: blue;"></div>
                                @endif
                            </div>
