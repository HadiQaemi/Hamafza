    ...
    @if(Auth::check())
        <div class="pull-left user-config dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <img class="img-responsive pull-right jsPanels" href="{{route('modals.profile_avatar')}}" src="{{route('FileManager.DownloadFile',['type'=>'ID','id'=>enCode(auth()->user()->avatar)])}}"/>
...
@include('layouts.helpers.common.sections.helpers.login_modal',['modal_id'=>'login','csrf'=>$csrf])
@include('layouts.helpers.common.sections.helpers.login_modal',['modal_id'=>'loginWmessage','modal_login_message'=>true,'csrf'=>$csrf])
@include('layouts.helpers.common.sections.helpers.register_modal')
@include('layouts.helpers.common.sections.helpers.remember_password_modal')
