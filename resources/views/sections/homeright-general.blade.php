        ...
        <div style="font-size:9pt;">
            <div class="HomeItemDiv general-list">
                ...
                <div style="display: inline;">
                    <a href="{{ auth()->user()->Uname }}/desktop/user_measures?tt=ME" style=";color:#FFF;">
            ...
            <div class="HomeItemDiv general-list">
                ...
                <div style="display: inline;">
                     <a href="{{ auth()->user()->Uname }}/desktop/inbox" style=";color:#FFF;">
            ...
            <div class="HomeItemDiv general-list">
                ...
                <div style="display: inline;">
                    <a href="{{ auth()->user()->Uname }}/desktop/followed" style=";color:#FFF;">
