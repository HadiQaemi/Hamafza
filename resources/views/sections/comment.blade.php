                        ...
                        <div style="height: 15px">
                            <ul class="titleCommand col-md-12 col-sm-12 col-xs-12 noPadding">
                                <li>
                                    ...
                                    <a style="height: 10px;"   title="ویدیو" data-placement="top" data-toggle="tooltip" id="vidUploadWs" class="fa icon-view-slide-active" href="#" style="font-size: 14pt;padding-top: 10px;height: 10px;"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="col-xs-8 hideW_on_type_2_1">
                                <select id="keywordsW" class="no-padding form-control select2_auto_complete_keywords" name="Commentkeywords2[]" ttype="12" data-placeholder="{{trans('tasks.can_select_some_options')}}" multiple="multiple"></select>
                                {{--@include('sections.commenttags')--}}
                            </td>
                            <td class="col-xs-3 showW_on_type_2_1"><div class="no-padding text-left">پاداش <input type="text" class="reward form-control" name="reward" id="reward" style="width: 70px; padding: 0; margin: 0; display: inline-block; height: 30px;" /> (امتیاز شما: <div style="direction: ltr; display: inline-block;">{!! get_user_sumscores() !!}</div>)</div></td>
                        </tr>
                    </table>
                    <table class="table">
                        <tr>
                                ...
                                success: function (data)
                                {
                                    if (data.success)
                                    {
                                        ...
                                        $.each(json_data, function (id, record)
                                        {
                                            ...
                                            portal_id.find('option:first-child').attr('selected', 'selected');
                                        });
                                    }
                                }
                            });
