            ...
            <div class="panel-body no-padding mCustomScrollbar" style="height: 400px;overflow: hidden">
                <ul class="underlined_menu nav nav-tabs">
                    ...
                    {{-- <li>
                     ...
                     <li>
                         <a data-toggle="tab" href="#tab_4">کتابخانه‌ها</a>
                     </li>
                     <li>
                         <a data-toggle="tab" href="#tab_5">همایش‌ها</a>
                     </li>
                     <li>
                         <a data-toggle="tab" href="#tab_6">انتشارات</a>
                     </li>--}}
                </ul>
                <div class="tab-content">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    @if(isset($value->items ) && $value->items->count())
                                        @foreach($value->items as $item)
                                            <div class="col-md-4 col-sm-4 col-xs-4" style="text-align: center">
                                                <a href="@foreach($item->attrs as $attr)@if($attr->pivot->basicdata_attribute_id==12){{Str::limit($attr->pivot->value, 30)}} @endif @endforeach" data-toggle="tooltip" title="@foreach($item->attrs as $attr)@if($attr->pivot->basicdata_attribute_id==12){{$attr->pivot->value}} @endif @endforeach" target="_blank">
                                                    <img style="width:80px; height: 80px; margin:auto;border-radius: 50%; border: 1px solid #CCCCCC;background: #FFF;padding: 2px; "
