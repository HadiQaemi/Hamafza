...
<span class="preheader" style="box-sizing: border-box; display: none !important; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all; opacity: 0; overflow: hidden; visibility: hidden;">از این لینک برای تغییر کلمه عبور استفاده نمایید. این لینک تا 24 ساعت معتبر است.</span>
                        ...
                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0 auto; padding: 0; width: 570px;" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                <td class="content-cell" style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; padding: 35px; word-break: break-word;">
                                    <h1 style="text-align: right; box-sizing: border-box; color: #2F3133; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;" align="left">، سلام{{ $info['email']}}</h1>
                                    <p style="text-align:right; box-sizing: border-box; color: #74787E; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left">شما اخیرا درخواست تغییر کلمه عبورتان را صادر کرده‌اید. از دکمه زیر برای ادامه فرآیند استفاده نمایید. <strong style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif;">این درخواست تنها تا 24 ساعت اعتبار خواهد داشت.</strong></p>

                                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; margin: 30px auto; padding: 0; text-align: center; width: 100%;">
                                        <tr>
                                            <td align="center" style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; word-break: break-word;">

                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif;">
                                                    <tr>
                                                        <td align="center" style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; word-break: break-word;">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                <tr>
                                                                    <td style="box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; word-break: break-word;">
                                                                        <a href="{{ url('/reset_password') . '/' . $info['reset_password'] }}" class="button button--green" target="_blank" style="-webkit-text-size-adjust: none; background: #22BC66; border-color: #22bc66; border-radius: 3px; border-style: solid; border-width: 10px 18px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); box-sizing: border-box; color: #FFF; display: inline-block; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; text-decoration: none;">بازنشانی رمز عبور</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                    ...
                                    <p style="text-align: right; box-sizing: border-box; color: #74787E; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left">اگر شما چنین درخواستی نداشته‌اید، این ایمیل را نادیده بگیرید.</p>
                                    <p style="text-align: right; box-sizing: border-box; color: #74787E; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left">با تشکر,
                                        <br />تیم پشتیبانی {{ config('constants.SiteTitle') }}</p>
                                    ...
                                    <table class="body-sub" style="border-top-color: #EDEFF2; border-top-style: solid; border-top-width: 1px; box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; margin-top: 25px; padding-top: 25px;">
                                        <tr>
                                            <td style="text-align: right; box-sizing: border-box; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; word-break: break-word;">
                                                <p class="sub" style="text-align: right; box-sizing: border-box; color: #74787E; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="left">اگر دکمه بالا کار نکرد، آدرس زیر را در مرورگر باز نمایید.</p>
                                                <p class="sub" style="text-align: right; box-sizing: border-box; color: #74787E; font-family: tahoma, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="left">{{ url('/reset_password') . '/' . $info['reset_password'] }}</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
