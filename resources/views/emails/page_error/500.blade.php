...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#999999" width="100%" style="background-color: #E57373">
    <tr>
        <td></td>
        <td class="header container">
            ...
            <div class="content">
                <table>
                    <tr>
                        <td align="right"><h2 style="margin-right: 100px; text-align: center;" class="collapse">هم‌افزا - گزارش خطای 500</h2></td>
