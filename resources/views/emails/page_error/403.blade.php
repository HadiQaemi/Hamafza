...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#999999" width="100%" style="background-color: #FF8A65">
    <tr>
        <td></td>
        <td class="header container" >
            ...
            <div class="content">
                <table bgcolor="#999999">
                    <tr>
                        <td align="right"><h2 style="margin-right: 100px; text-align: center;" class="collapse">هم‌افزا - گزارش خطای 403</h2></td>
