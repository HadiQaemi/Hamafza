<div class="row">
    <div class="base_tabs">
        <ul class="nav nav nav-tabs">
            ...
            <li id="tab_insert_charts"><a data-toggle="pill" href="#add_chart">ایجادچارت</a></li>
        </ul>
        ...
        <div class="tab-content">
                ...
                <div id="add_chart" class="tab-pane fade">
                    <div style="padding: 15px;">
                        ...
                        <form id="FormInsertChart">
                            ...
                            <div class="space-4"></div>
                            <div>
                                <textarea name="chart_description" type="text" class="form-control" id="New_ChartDesc"></textarea>
                            </div>
