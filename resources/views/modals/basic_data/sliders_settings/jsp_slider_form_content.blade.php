    ...
    <div style="padding: 10px;">
        <div class="row" style="margin-top: 5px;">
            ...
            <div class="col-sm-6"><label>آدرس لینک:</label> <input type="text" id="url_address" name="url_address" class="form-control" style="direction: ltr;"
                                                                   value="{{ $basic_data_value ? $basic_data_value->attrs()->where('basicdata_attribute_id', 5)->withPivot('value')->first()->pivot->value : '' }}"/></div>
        </div>
        <div class="row" style="margin-top: 5px;">
            <div class="col-sm-8">
                ...
                <div id="new_header_image" class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! $HFMAddSliderImage['Buttons']['slider_image'] !!}
                        {!! $HFMAddSliderImage['ShowResultArea']['slider_image'] !!}
                    </div>
                </div>
            </div>
            <div id="old_right_logo" class="col-sm-4">
                <div style="height: 120px; width: 180px; text-align: center;">
                    <img style="height: 120px; width: 180px;"
                         src="{{route('FileManager.DownloadFile',['ID', $basic_data_value? enCode($basic_data_value->attrs()->where('basicdata_attribute_id', 6)->withPivot('value')->first()->pivot->value) : -1 ]) }}"
                         alt="">
                </div>
            </div>
        </div>
