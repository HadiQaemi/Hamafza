    ...
    <div class="tab-content">
        <div class="tab-pane active tab-view" id="tab_t1">
            <div class="col-xs-12 line-height-35 margin-top-20">
                <div class="col-xs-1">{{trans('projects.title')}}</div>
                <div class="col-xs-11">
            ...
            {{--</div>--}}
            <div class="col-xs-12 line-height-35 margin-top-20">
                <div class="col-xs-1">{{trans('projects.describe')}}</div>
                <div class="col-xs-11">
            ...
            <div class="col-xs-12 margin-top-60">
                <div class="col-xs-1 line-height-35">{{trans('projects.top')}}</div>
                <div class="col-xs-11">
            ...
            <div class="col-xs-12 margin-top-10" style="border-top: #ccc solid 1px;padding-top: 10px">
                <div class="col-xs-1 line-height-35">{{trans('projects.project_manager')}}</div>
                <div class="col-xs-11">
            ...
            <div class="col-xs-12 margin-top-10">
                <div class="col-xs-1 line-height-35">{{trans('projects.keywords')}}</div>
                <div class="col-xs-11 nput-group pull-right">
            ...
            <div class="col-xs-12 line-height-35 margin-top-20" style="border-top: #ccc solid 1px;padding-top: 10px">
                <div class="col-xs-1">{{trans('projects.schedule_base')}}</div>
                <div class="col-xs-11">
            ...
            <div class="col-xs-12 line-height-35 margin-top-20">
                <div class="col-xs-1">{{trans('projects.end_date')}}</div>
                ...
                <div class="col-xs-1">{{trans('projects.final_date')}}</div>
                <div class="col-xs-2 nput-group pull-right">
                    {{--<span class="input-group-addon" id="respite_date">--}}
                        {{--<i class="fa fa-calendar"></i>--}}
                    {{--</span>--}}
            ...
            <div class="col-xs-12 line-height-35 margin-top-20">
                <div class="col-xs-1">{{trans('projects.current_date')}}</div>
                <div class="col-xs-2 nput-group pull-right">
                    {{--<span class="input-group-addon" id="respite_date">--}}
                    {{--<i class="fa fa-calendar"></i>--}}
                    {{--</span>--}}
                ...
                <div class="col-xs-1">{{trans('projects.status_date')}}</div>
                <div class="col-xs-2 nput-group pull-right">
                    {{--<span class="input-group-addon" id="respite_date">--}}
                    {{--<i class="fa fa-calendar"></i>--}}
                    {{--</span>--}}
            ...
            <div class="col-xs-12 line-height-35 margin-top-20">
                <div class="col-xs-1">{{trans('projects.base_calendar')}}</div>
                <div class="col-xs-2 nput-group pull-right">
                ...
                <div class="col-xs-1">{{trans('projects.priority')}}</div>
                <div class="col-xs-2 nput-group pull-right">
        ...
        <div class="modal-dialog modal-xs">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="color:red;" id="confirm_modal_title">{{trans('app.error')}}</h4>
                </div>
