<div class="panel panel-default" style="margin: 10px;">
    ...
    <div class="panel-body">
        <table id="grid" width="100%" class="table table-condensed table-bordered table-striped table-hover td-center-align">
            ...
            <th style="text-align: center;">{{ trans('tools.keywords') }}</th>
...
<script>
    ...
    ({
        ...
        initComplete: function ()
        {
            $("div.toolbar").html
            (
                '<a href="{!! route('modals.basicdata_slider_settings_view') !!}" class="jsPanels createnewvalue1">' +
            ...
            [
                ...
                },
                {
                    ...
                    mRender: function (data, type, full)
                    {
                        ...
                        make_edit = '<a class="jsPanels" data-test="test" href="{!! route('modals.basicdata_news_settings_view') !!}?data=' + full.id + '"><i class="fa fa-pencil-square-o"></i></a>';
