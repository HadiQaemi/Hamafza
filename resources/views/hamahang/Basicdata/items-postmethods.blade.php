...
<div class="panel panel-default" style="margin: 10px;">
    ...
    <div class="panel-body">
        <table id="grid" width="100%" class="table table-condensed table-bordered table-striped table-hover td-center-align">
            ...
            <th style="text-align: center;">{{ $value_text }}</th>
...
<script>
    function edit_value(id)
    {
        ...
        ({
            type: 'post',
            url: '{!! route('modals.basicdata_value_create_edit_post_methods') !!}',
            data: {'editid': id, 'parentid': e_parentid.val(), 'title': e_title.val(), 'value': e_value.val(), 'inactive': e_inactive.val(), 'comment': e_comment.val(), 'a': e_a.val()},
            dataType: 'json',
    ...
    function get_content(id, title, value, inactive, a, parentid)
    {
        ...
        [
            ...
            },
            {
                ...
                mRender: function (data, type, full)
                {
                    ...
                    data_content_function = 'get_content(\'' + full.id + '\', \'' + full.title + '\', \'' + full.value + '\', \'' + full.inactive + '\', \'' + full.a + '\', \'' + full.parent_id + '\')';
