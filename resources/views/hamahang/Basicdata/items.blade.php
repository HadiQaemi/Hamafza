...
<script>
    ...
    function get_content(id, title, value, parentid)
    {
        ...
        '       <div class="col-sm-3"><label>مقدار:</label> <input type="text" id="value" name="value" class="form-control" style="direction: ltr;" value="' + value + '" /></div>' +
        '   </div>' +
        '   <div class="row" style="margin-top: 5px;">' +
        ...
        [
            ...
            },
            {
                ...
                mRender: function (data, type, full)
                {
                    ...
                    data_content_function = 'get_content(\'' + full.id + '\', \'' + full.title + '\', \'' + full.value + '\', \'' + full.parent_id + '\')';
