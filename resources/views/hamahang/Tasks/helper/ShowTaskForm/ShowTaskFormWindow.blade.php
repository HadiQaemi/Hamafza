...
//        echo (Auth::getUser()->Name.' '.Auth::getUser()->Family);
        $task = $res['task'];
    ?>
        {{--</pre>--}}
    {{--<form action="{{ route('hamahang.tasks.save_task') }}" class="" name="ShowTaskForm" id="ShowTaskForm" method="post"--}}
    <form action="{{ route('hamahang.tasks.update_task') }}" class="" name="ShowTaskForm" id="ShowTaskForm" method="post"
        ...
        <div class="tab-content">
            <div class="tab-pane active" style="padding-top: 8px" id="tab_t1">
                ...
                <table class="table col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 line-height-35" style="padding-top: 5px;padding-bottom: 5px;">
                                        <div class="pull-right" style="height: 30px;line-height: 30px;border-left:1px solid #aaa">
                                            <input type="radio" name="type" value="0" id="official" {{$task['type'] ==0 ? 'checked' : ''}}/>
                                            <label for="official">{{ trans('app.official') }}</label>
                                            <input type="radio" name="type" value="1" id="unofficial" {{$task['type'] ==1 ? 'checked' : ''}}/>
                                            <label for="unofficial">{{ trans('app.unofficial') }}</label>
                                        </div>
                                        <div class="pull-right" style="height: 30px;line-height: 30px;border-left:1px solid #aaa">
                                            <input type="radio" name="kind" value="1" id="kind_activity" {{$task['kind'] ==1 ? 'checked' : ''}}/>
                                            <label for="kind_activity">{{ trans('tasks.activity') }}</label>
                                            <input type="radio" name="kind" value="0" id="kind_event" {{$task['kind'] ==0 ? 'checked' : ''}}/>
                                            <label for="kind_event">{{ trans('tasks.event')}}</label>
                                        </div>
                                        <div class="pull-right" style="height: 30px;line-height: 30px;border-left:1px solid #aaa">
                                            <input type="radio" name="importance" value="1" {{$task['importance'] ==1 ? 'checked' : ''}}/>
                                            <label>{{ trans('tasks.important') }}</label>
                                            <input type="radio" name="importance" value="0" {{$task['importance'] ==0 ? 'checked' : ''}}/>
                                            <label>{{ trans('tasks.unimportant')}}</label>
                                        </div>
                                        <div class="pull-right" style="height: 30px;line-height: 30px;">
                                            <input type="radio" name="immediate" value="1" {{$task['immediate'] ==1 ? 'checked' : ''}}/>
                                            <label>{{ trans('tasks.immediate') }}</label>
                                            <input type="radio" name="immediate" value="0" {{$task['immediate'] ==0 ? 'checked' : ''}}/>
                        ...
                        <td style="border: none;">
                            <div class="row-fluid">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 line-height-35">
                                    <input type="text" class="form-control row" name="task_desc" id="desc" value="{{$task['task_desc']}}"/>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="row-fluid">
                                <div class="col-sm-6 row" style="padding-left: 0px;">
                                    <select id="new_task_users___" name="users[]" class="select2_auto_complete_user col-xs-12"
                                ...
                                <div class="col-sm-6 line-height-35" style="padding-right: 5px;">
                                    ...
                                    <input type="radio" name="assign_type" id="use_type1" class="" value="1" checked/>
                                    <label class="" for="use_type1">{{ trans('tasks.collective') }}</label>
                                    <input type="radio" name="assign_type" id="use_type2" class="" value="2"/>
                                    <label class="" for="use_type2">{{ trans('tasks.individual') }}</label>

                                    <input type="checkbox" name="send_mail" id="send_mail" class="" value="1"/>
                                    <label class="" for="send_mail">{{ trans('tasks.send-mail') }}</label>
                                    <input type="checkbox" name="send_sms" id="send_sms" class="" value="1"/>
                        ...
                        <td style="border: none;">
                            <div class="row-fluid">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 smaller-90 line-height-35" style="padding-right: 5px;">
                                    ...
                                    <input type="checkbox" name="report_on_cr" id="report-type1" class="" value="1"/>
                                    <label for="report-type1" class="">{{ trans('tasks.report_on_task_creation') }}</label>
                                    <input type="checkbox" name="report_on_co" id="report-type2" class="" value="1"/>
                                    <label for="report-type2" class="">{{ trans('tasks.report_on_task_completion') }}</label>
                                    <input type="checkbox" name="report_to_manager" id="report-type3" class="" value="1"/>
                    ...
                    <tr>
                        ...
                        <td style="border: none;">
                            <div id="respite_span">
                                <div class="col-xs-2">
                                    <input type="radio" name="respite_timing_type" id="determination_doing_duration" onclick="change_normal_task_timing_type(0)" value="0" {{ $task['respite_timing_type']==0 ? '' : 'checked' }}/>
                                    <label for="determination_doing_duration">{{ trans('tasks.determination_doing_duration') }}</label>
                                    <input type="radio" name="respite_timing_type" id="determination_end_date" onclick="change_normal_task_timing_type(1)" value="1" {{ $task['respite_timing_type']==1 ? '' : 'checked' }}/>
                                        ...
                                        <div class=" col-md-12 col-sm-12 col-xs-12 form-inline line-height-35">
                                            <div class="row-fluid">
                                                <div class="col-sm-12 col-xs-12 form-inline">
                                                    <input class="form-control col-xs-1 pull-right" style="width: 55px" name="duration_day" id="duration_day" value="{{isset($task['duration_day']) ? $task['duration_day'] : ''}}" />
                                                    <label class="pull-right">روز</label>
                                                    <input class="form-control col-xs-1 pull-right" style="width: 55px" name="duration_hour" id="duration_hour" value="{{isset($task['duration_hour']) ? $task['duration_hour'] : ''}}"/>
                                                    <label class="pull-right">ساعت</label>
                                                    <input class="form-control col-xs-1 pull-right" style="width: 55px" name="duration_min" id="duration_min" value="{{isset($task['duration_min']) ? $task['duration_min'] : ''}}"/>
                                ...
                                <div class="col-xs-4">
                                    <input type="radio" name="respite_timing_type" id="on-time" onclick="" value="2" {{ $task['respite_timing_type']==2 ? '' : 'checked' }}/>
                                    <label for="on-time">{{ trans('tasks.on-time') }}</label>
                                    <input type="radio" name="respite_timing_type" id="no-detemine" onclick="" value="3" {{ $task['respite_timing_type']==3 ? '' : 'checked' }}/>
                ...
                <input type="hidden" name="task_of_action" id="task_form_action" />
                ...
                <div class="input-group pull-right col-xs-12" style="margin: 0 0 15px 5px;">
                    <div class="col-xs-2">
                        <select id="task_schedul" name="task_schedul" class="form-control">
                            <option value="daily" {{$task['task_schedul'] == 'daily' ? 'selected="selected"' : ''}}>{{trans('tasks.daily')}}</option>
                            <option value="weekly" {{$task['task_schedul'] == 'weekly' ? 'selected="selected"' : ''}}>{{trans('tasks.weekly')}}</option>
                            <option value="monthly" {{$task['task_schedul'] == 'monthly' ? 'selected="selected"' : ''}}>{{trans('tasks.monthly')}}</option>
                            <option value="seasonly" {{$task['task_schedul'] == 'seasonly' ? 'selected="selected"' : ''}}>{{trans('tasks.seasonly')}}</option>
                            <option value="yearly" {{$task['task_schedul'] == 'yearly' ? 'selected="selected"' : ''}}>{{trans('tasks.yearly')}}</option>
                        </select>
                    </div>
                    <div class="col-xs-10 div-schedul">
                        <div class="daily {{($task['daily_num']>0) ? '' : 'hidden'}} col-xs-12">
                            <div class="daily col-xs-2" style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;height: 52px;">
                                ...
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" id="daily_num" class="form-control" style="width: 40px;" name="daily_num" value="{{$task['daily_num']}}" >
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                        ...
                        <div class="weekly {{isset($task['weekly_value']) ? '' : 'hidden'}} col-xs-12">
                            <div class="weekly col-xs-2"  style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;height: 52px;">
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                    <label style="line-height: 10px;" >{{trans('tasks.every')}}</label>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" id="weekly_num" class="form-control" style="width: 40px;" name="weekly_num" value="{{$task['daily_num']}}" >
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                ...
                                @for ($i = 0; $i < 7; $i++)
                                    <div class="input-group pull-right weekly" style="margin: 0 0 5px 5px;width: 13%">
                                        <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                            ...
                                            {{isset($task['weekly_value']) ? (in_array($i,$task['weekly_value']) ? 'checked="checked"' : '') : ''}}
                                            >
                                        </span>
                                        <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                        ...
                        <div class="monthly {{isset($task['monthly_value']) ? '' : 'hidden'}}">
                            <div class="monthly col-xs-2"  style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;height: 52px;">
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                    <label style="line-height: 10px;" >{{trans('tasks.every')}}</label>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" id="monthly_num" class="form-control" style="width: 40px;" name="monthly_num" value="{{ $task['monthly_num'] }}" >
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                    ...
                                    <div class="input-group pull-right monthly" style="margin: 0 0 5px 5px;width: 13%">
                                        <span class="input-group-addon edited-addon" style="padding: 0 5px 0 0; margin: 0 5px 0 0;">
                                            <input id="monthly_value_{{$i}}" class="form-control pull-right" style="width: 22px;" name="monthly_value[]" type="checkbox" value="{{$i}}"
                                                    {{isset($task['monthly_value']) ? (in_array($i,$task['monthly_value']) ? 'checked="checked"' : '') : ''}}
                                            >
                                        </span>
                                        <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                        ...
                        <div class="seasonly {{isset($task['seasonly_value']) ? '' : 'hidden'}}">
                            <div class="seasonly col-xs-2" style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;height: 52px;">
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                    <label style="line-height: 10px;" >{{trans('tasks.every')}}</label>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" id="seasonly_num" class="form-control" style="width: 40px;" name="seasonly_num" value="{{ $task['seasonly_num'] }}" >
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                ...
                                @for ($i = 0; $i < 4; $i++)
                                    <div class="input-group pull-right seasonly" style="margin: 0 0 5px 5px;width: 22%">
                                        <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                            ...
                                            {{isset($task['seasonly_value']) ? (in_array($i,$task['seasonly_value']) ? 'checked="checked"' : '') : ''}}
                                            >
                                        </span>
                                        <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                        ...
                        <div class="yearly {{isset($task['yearly_value']) ? '' : 'hidden'}} ">
                            <div class="yearly col-xs-2" style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;height: 52px;">
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                    <label style="line-height: 10px;" >{{trans('tasks.every')}}</label>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" id="yearly_num" class="form-control" style="width: 40px;" name="yearly_num" value="{{ $task['yearly_num'] }}" >
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                    ...
                    <div class="col-xs-12" style="margin: 15px 0 0px 5px;">
                        <div class="col-xs-3" style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;height: 52px;">
                            ...
                            <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                <input type="text" value="" class="form-control DatePicker" name="schedul_begin_date" aria-describedby="schedul_begin_date" id="schedul_begin_date">
                            </span>
                        </div>
                        <div class="col-xs-9" style="border: solid 1px #eee !important;border-radius: 4px;padding: 5px;">
                            ...
                            <div class="daily col-xs-2" style="margin: 0 0 5px 5px;">
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;height: 34px !important;">
                                    <input type="radio" name="schedul_end_date" {{ $task['schedul_end_date']=='schedul_end_date_none' ? 'checked="checked"' : '' }} value="schedul_end_date_none" id="schedul_end_date_none"/>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                            ...
                            <div class="daily col-xs-3" style="margin: 0 0 5px 5px;">
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="radio" name="schedul_end_date" {{ $task['schedul_end_date']=='schedul_end_date_events' ? 'checked="checked"' : '' }} value="schedul_end_date_events" id="schedul_end_date_events"/>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                                    <label for="schedul_end_date_events">{{ trans('tasks.after') }}</label>
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" id="schedul_end_date_events_" class="form-control" style="width: 40px;" name="schedul_end_num_events" value="{{ $task['schedul_end_num_events'] }}" >
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0px; margin: 0px;">
                            ...
                            <div class="daily col-xs-2" style="margin: 0 0 5px 5px;">
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;height: 34px">
                                    <input type="radio" name="schedul_end_date" value="schedul_end_date_date" id="schedul_end_date_date" {{ $task['schedul_end_date']=='schedul_end_date_date' ? 'checked="checked"' : '' }} />
                                </span>
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;height: 34px">
                            ...
                            <div class="daily col-xs-3" style="margin: 0 0 5px 5px;">
                                <span class="input-group-addon edited-addon" style="padding: 0 5px 0 5px; margin: 0 5px 0 5px;">
                                    <input type="text" class="form-control DatePicker" name="schedul_end_date_date" aria-describedby="schedul_end_date_date" id="schedul_end_date_">
                                </span>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr id="num_add_rel_task{{$k.'show'}}">
                                    ...
                                    <td>
                                        <label class="input-group pull-right">
                                            ...
                                            <input name="new_task_weight[]" type="hidden" value="{{$res['task']['new_task_weight'][$k]}}"/>
                                        </label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <label class="input-group pull-right">
                                            <div class="col-xs-6"><input name="new_task_delay_num[]" value="{{$res['task']['new_task_delay_num'][$k]}}" type="text" class="form-control" placeholder="وقفه"/></div>
            ...
            <div class="tab-pane" id="tab_t6" style="padding: 8px;">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-8">
                        ...
                        <input type="hidden" id="user" class="form-control" value="{{Auth::getUser()->Name.' '.Auth::getUser()->Family}}"/>
                    </div>
                    <div class="col-xs-1">
