...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <fieldset>
                <legend>لیست فرآیندها ( پیش نویس ها )</legend>
                <div class="col-md-12">
                    <div class="row">
                        <a class="pull-left cursor-pointer"
                           href="{{ route('ugc.desktop.hamahang.process.index',['username'=>$uname]) }}"><span>ایجاد فرآیند جدید</span></a>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="tab" class="container table-bordered" style="width: 95%">
                        <ul class="nav nav-tabs">
                            <li>
                                <a href="#t1" data-toggle="tab" class="active">اطلاعات</a>
                            </li>
                            <li>
                            ...
                            <div class="tab-pane active" style="padding-top: 8px" id="t1">
                                <table class="table table-bordered col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-10">
                                            <select class="js-data-example-ajax" id="process_pages" name="process_pages"
                                                    multiple>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-10">
                                            <select id="process_keywords" multiple></select>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <table class="table" dir="">
                                                <tr>
                                                    <td><span class="">از تاریخ :  </span><input class="form-control"/></td>
                                                    <td>
                                        ...
                                        <span>
                                           <span class="">تا تاریخ :  </span><input class="form-control"/>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div>پیشرفت کل : <input type="text" id="progress_amount" class="form-control"/></div>
                                                    </td>
                                                    <td>
                                                        <div>مدت : <input type="text" id="duration" class="form-control"/></div>
                                                    </td>
                                                    <td>
                                                        <div>واریانس : <input type="text" id="variance" class="form-control"/></div>
                                                    </td>
                                                    <td>
                                                        <div>ورودی ها : <input type="text" id="" class="form-control"/></div>
                                                    </td>
                                                    <td>
                            ...
                            <td class="">
                                <div class="col-md-6">
                                    <select id="ModifyEditPermittedUsers"
                                            ...
                                            class="select2_auto_complete_user col-md-12 "
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            window.ProcessList = $('#ProcessList').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('hamahang.Process.drafts_list') }}" ,
                    "type": "POST"
                },
                "autoWidth": false,
                "processing": true,
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            ...
                            return "<a class='cls3' style='margin: 2px' onclick='process_info(" + full.id + ",\"" + full.title + "\")' href=\"#\"><i class=''>ویرایش</i></a>|<a \
                            class='cls3' style='margin: 2px' onclick='add_task(" + full.id + ")' href=\"#\"><i class=''>حذف</i></a>";
        ...
        function refresh_edit_permitted_users_table(id) {
            ...
            window.edit_permitted_users = $('#edit_permitted_users_table').DataTable({
                "dom": window.CommonDom_DataTables,
                "ajax": {
                    "url": "{{ route('hamahang.process.process_task_edit_permitted_users',['username'=>$uname ,'id'=>'/' ]) }}" + "/" + id,
                    "type": "POST"
                },
                "autoWidth": false,
                "language": window.LangJson_DataTables,
...
//
        ...
        function add_next_task(id) {
            ...
            $.ajax({
                type: "POST",
                url: '{{ URL::route('hamahang.process.add_next_task',['username'=>$uname]) }}',
                dataType: "json",
                data: sendInfo,
                success: function (data) {
...
//
        ...
        function ShowProcessTasks(id) {
            ...
            window.process_task_table = $('#ProcessTaskTable').DataTable({
                "dom": window.CommonDom_DataTables,
                "ajax": {
                    "url": "{{ route('hamahang.process.tasks',['username'=>$uname ,'id'=>'/' ]) }}" + "/" + id,
                    "type": "POST"
                },
                "autoWidth": false,
                "language": window.LangJson_DataTables,
...
//
        ...
        function ShowProcessTaskEditPermissions(id) {
            ...
            window.process_task_edit_permissions = $('#user_with_edit_permission').DataTable({
                "dom": window.CommonDom_DataTables,
                "ajax": {
                    "url": "{{ route('hamahang.process.process_tasks',['username'=>$uname ,'id'=>'/' ]) }}" + "/" + id,
                    "type": "POST"
                },
                "autoWidth": false,
                "pageLength": 5,
...
//                    {"data": "employee_name"},
        ...
        function process_task_info(id, title) {
            ...
            $("#next_tasks").select2({
                ...
                tags: false,
                ajax: {
                    url: "{{ route('hamahang.process.search_process_task',['username'=> $uname ,'id'=>'/' ]) }}" + "/" + current_process_task_id,
                    dataType: "json",
                    type: "POST",
                    quietMillis: 150,
                    data: function (term) {
        ...
        function process_info(id, title) {
            var select_task_function = ' <a class="cursor-pointer" onclick="show_select_tasks_window_modal(200,current_id)"><span\
        class=""></span>کتابخانه وظایف</a>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var exist_pages = '';
                    $.each(data['pages'][0], function (key, value) {

                        exist_pages += "<option value=" + value.id + " selected='selected'>" + value.title + "</option>";


                    });

                    // $('#process_pages').html(exist_pages);
