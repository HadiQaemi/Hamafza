<style>
    ...
    <div id="related_links"  >
        @if(!isset($filter_subject_id))
            ...
            <a class="@if( Route::currentRouteName() == 'ugc.desktop.hamahang.tasks.my_assigned_tasks.state') current_page @endif" href="{{ route('ugc.desktop.hamahang.tasks.my_assigned_tasks.state',['username'=>auth()->user()->Uname]) }}"><span><i class="fa fa-bar-chart" title="{{ trans('projects.table_task_projects') }}"></i></span></a>
            <a class="@if( Route::currentRouteName() == 'ugc.desktop.hamahang.tasks.my_assigned_tasks.priority') current_page @endif" href="{{ route('ugc.desktop.hamahang.tasks.my_assigned_tasks.priority',['username'=>auth()->user()->Uname]) }}"><span><i class="fa fa-retweet" title="{{ trans('projects.chart_task_projects') }}"></i></span></a>
            <a class="@if( Route::currentRouteName() == 'ugc.desktop.hamahang.project.list') current_page @endif" href="{{ route('ugc.desktop.hamahang.tasks.my_assigned_tasks.list',['username'=>auth()->user()->Uname]) }}"><span><i class="fa fa-list-alt" title="{{ trans('projects.table_task_projects') }}"></i></span></a>
        @else
            ...
            <a class="@if( Route::currentRouteName() == 'ugc.desktop.hamahang.project.list') current_page @endif" href="{{ route('pgs.desktop.hamahang.tasks.my_assigned_tasks.list',['username'=>auth()->user()->Uname]) }}"><span><i class="fa fa-list-alt" title="{{ trans('projects.table_task_projects') }}"></i></span></a>
        @endif
    </div>
