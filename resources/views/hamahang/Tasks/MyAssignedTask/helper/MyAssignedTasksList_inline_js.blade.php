<script>
    ...
    $('#title, .task_status, .draft_tasks, .task_immediate, .task_important, .official_type, input[name="draft_tasks"], input[name="task_status[]"], input[name="task_final[]"], input[name="task_immediate[]"], input[name="official_type[]"], input[name="task_important[]"], input[name="task_important_immediate[]"]').on('keyup change', function () {
        filter_tasks_priority();
    });
