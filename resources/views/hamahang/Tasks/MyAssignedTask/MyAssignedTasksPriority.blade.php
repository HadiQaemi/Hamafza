...
@section('content')
    ...
    <div class="row-fluid" style="background-color: white">
        <fieldset><legend>اولویت وظایف ارجاعی توسط من</legend>
            <div class="container col-xs-12" style="margin-top: 25px;">
                <div class="row-fluid">
                    <div class="form-inline col-xs-6" style="font-size: 10px;">
                        ...
                        <input type="number" class="form-control " style="width: 60px;" name="respite" id="filter_respite"/>
                    </div>
                    <div class="form-inline col-xs-6" style="font-size: 10px;">
                    ...
                    <div class="col-xs-6">
                        <div class="panel panel-default ">
                            ...
                            <div class="panel-body firstContent psize" level="1" id="firstContent">
                                <div class="row-fluid scroll_x_hidden" level="1" id="type1_tasks"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body secendContent psize" level="2" id="secendContent">
                                <div class="row-fluid scroll_x_hidden" level="2" id="type2_tasks">
                    ...
                    <div class="col-xs-6">
                        <div class="panel panel-default ">
                            ...
                            <div class="panel-body thirdContent psize" level="3" id="thirdContent">
                                <div class="row-fluid scroll_x_hidden" level="3" id="type3_tasks" >
                    ...
                    <div class="col-xs-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body  fourthContent psize " level="4" id="fourthContent">
                                <div class="row-fluid scroll_x_hidden" level="4" id="type4_tasks">
...
@section('inline_scripts')
    @include('hamahang.Tasks.MyAssignedTask.helper.MyAssignedTasksPriority_inline_js')
@stop
