<div class="col-xs-12 col-md-3 col-sm-6 pdrl-2">
    ...
    <div class="div_groups_task state_container">
        <ul class="droppable ul_dropp" id="task_notstarted">
...
<div class="col-xs-12 col-md-3 col-sm-6 pdrl-2">
    ...
    <div class="div_groups_task state_container">
        <ul class="droppable ul_dropp" id="task_started">
...
<div class="col-xs-12 col-md-3 col-sm-6 pdrl-2">
    ...
    <div class="div_groups_task state_container">
        <ul class="droppable ul_dropp" id="task_done">
...
<div class="col-xs-12 col-md-3 col-sm-6 pdrl-2">
    ...
    <div class="div_groups_task state_container">
        <ul class="droppable ul_dropp" id="task_ended">
