        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <ul class='nav nav-wizard'>
                    ...
                    <li class='active'><a href='#step1'>{{trans("calendar_events.ce_modal_session_navbar_nav1")}}</a></li>

                    <li><a href='#step2'>{{trans("calendar_events.ce_modal_session_navbar_nav2")}}</a></li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-md-10">
                                                            ...
                                                            <div class="col-md-12 form-inline line-height-25">
                                                                @foreach($HFM_Session['Buttons'] as $key => $value)
                                                                    {!! $value !!}
                                                                    {!! $HFM_Session['ShowResultArea'][$key] !!}
                                                                @endforeach
                                                            </div>
                                                            <!-- </div>-->
                                                        </td>
                                ...
                                <div class="btnContent">
                                    <button type="button" name="saveSession" id="saveSession"
                                        ...
                                        <i class="glyphicon  glyphicon-save-file bigger-125">
                                            <span>{{trans('ce_saved_label')}}</span></i>
                                    </button>
                                </div>
                            </div>
