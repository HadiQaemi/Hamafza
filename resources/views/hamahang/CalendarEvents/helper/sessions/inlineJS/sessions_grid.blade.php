                ...
                columns: [
                    {   data: 'title',
                        ...
                        mRender :function(data, type, full)
                        {
                            ...
                            return "<div class='" + ( full.assignment_assignment==1 ? 'color_grey' : '' ) + "' data-toggle='tooltip' title='"+full.agendas+"'>"+full.title+"</div><div class='' style='margin: 2px 0px;padding: 5px;'>"+data2+"</div>";
                            // }
                        }
                    },
                    {
