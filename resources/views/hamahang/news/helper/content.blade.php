<div class="h-content">
    <div id="tab" class="row-fluid" style="width: 100%;">
        <ul class="nav nav-tabs">
            ...
            --}}
            <li>
                <a href="#t20" id="th20" data-id="20" data-toggle="tab"><i class="fa fa-sort-amount-desc" data-ord="desc"></i> {{ trans('enquiry.new') }}</a>
            </li>
            {{--
            <li>
            ...
            --}}
            <li style="margin: 8px;">
                <button class="btn btn-success btn-sm jsPanels" href="{!! route('modals.new_subject') . '?uid=' . auth()->id() . "&sid=$sid" . ' ' . '&type=subject&pid=' . $pid !!}" title="صفحه جدید">
                    <span>خبر جدید</span>
                </button>
            </li>
        ...
        <div class="tab-content" style="min-height: 550px; padding: 0 20px;">
