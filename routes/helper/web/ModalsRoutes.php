...
Route::group(['prefix' => 'modals', 'middleware' => ['dynamic_permission:modals']], function ()
{
    ...
    Route::post('basicdata_get_users_scores', ['as' => 'modals.basicdata_get_users_scores', 'uses' => 'View\ModalController@basicdataGetUsersScores']);
    /* ??? */Route::post('newCircle', ['as' => 'new_circle', 'uses' => 'View\ModalController@newCircle']);
    /* ??? */Route::post('login', ['as' => 'login', 'uses' => 'View\ModalController@login']);
    Route::post('message', ['as' => 'message', 'uses' => 'View\ModalController@message']);
    /* ??? */Route::post('neworgan', ['as' => 'new_organ', 'uses' => 'View\ModalController@newOrgan']);
    /* ??? */Route::post('announce', ['as' => 'announce', 'uses' => 'View\ModalController@announce']);
    /* ??? */Route::post('print', ['as' => 'print', 'uses' => 'View\ModalController@mPrint']);
    /* ??? */Route::post('export', ['as' => 'export', 'uses' => 'View\ModalController@export']);
    /* ??? */Route::post('notification', ['as' => 'notification', 'uses' => 'View\ModalController@notification']);
    /* ??? */Route::post('delete', ['as' => 'delete', 'uses' => 'View\ModalController@mDelete']);
    /* ??? */Route::post('history', ['as' => 'history', 'uses' => 'View\ModalController@history']);
    /* ??? */Route::post('seluser', ['as' => 'sel_user', 'uses' => 'View\ModalController@seluser']);
    Route::post('setting', ['as' => 'setting', 'uses' => 'View\ModalController@setting']);
    Route::post('keyword_addedit_form', ['as' => 'modals.keyword_add_edit_form', 'uses' => 'View\ModalController@keyword_addedit_form']);
    /* ??? */Route::post('keyword_addedit', ['as' => 'modals.keyword_add_edit', 'uses' => 'View\ModalController@keyword_addedit']);
    /* ??? */Route::post('newgroup', ['as' => 'new_group', 'uses' => 'View\ModalController@newGroup']);
    Route::post('viewmessage', ['as' => 'modals.view_message', 'uses' => 'View\ModalController@viewMessage']);
    /* ??? */Route::post('getaccessusers', ['as' => 'get_access_users', 'uses' => 'View\ModalController@getAccessUsers']);
    /* ??? */Route::post('pageinsubject', ['as' => 'page_in_subject', 'uses' => 'View\ModalController@pageinSubject']);
    /* ??? */Route::post('addresses', ['as' => 'modals.addresses', 'uses' => 'View\ModalController@addresses']);
    /* ??? */Route::post('addresses_form', ['as' => 'modals.addresses_form', 'uses' => 'View\ModalController@addresses_form']);
    ...
    /* ??? */Route::post('CreateNewCalendar', ['as' => 'modals.create_new_calendar', 'uses' => 'View\ModalController@CreateNewCalendar']);
    /* ??? */Route::post('BasicData_adssetting_view', ['as' => 'modals.BasicData_adssetting_view', 'uses' => 'View\ModalController@BasicData_adssetting_view']);
    /* ??? */Route::post('BasicdataValueCreateEdit_adsettings', ['as' => 'modals.BasicdataValueCreateEdit_adsettings', 'uses' => 'View\ModalController@BasicdataValueCreateEdit_adsettings']);
    /* ??? */Route::post('BasicData_value_edit_view', ['as' => 'modals.basicdata_value_edit_view', 'uses' => 'View\ModalController@BasicData_value_edit_view']);
   // Route::get('url/{url_type}/{url_href}', ['as' => 'modals.url', 'uses' => 'View\ModalController@URL', 'middleware' => ['dynamic_permission:modals.url']]);
    ...
    {
        Route::post('/view', ['uses' => 'View\ModalController@help_view', 'as' => 'modals.help.view', ]);
        Route::group(['prefix' => 'seealso'], function ()
        {
            Route::post('/', ['uses' => 'View\ModalController@help_seealso', 'as' => 'modals.help.seealso', ]);
            Route::post('/add', ['uses' => 'View\ModalController@help_seealso_add', 'as' => 'modals.help.seealso_add', ]);
