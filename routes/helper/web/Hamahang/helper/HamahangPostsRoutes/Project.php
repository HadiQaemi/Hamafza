...
/* ??? */Route::post('FetchList', ['as' => 'hamahang.project.list', 'uses' => 'ProjectController@FetchProject']);
/* ??? */Route::post('FetchRelations/{id}', ['as' => 'hamahang.project.fetch_relations', 'uses' => 'ProjectController@FetchRelations']);
