...
/* ??? */Route::post('task_states', ['as' => 'hamahang.tasks.add_task_ajax', 'uses' => 'MyAssignedTaskController@add_task_ajax']); /// create new task using ajax
/* ??? */Route::post('task_details2', ['as' => 'hamahang.tasks.info2', 'uses' => 'TaskController@task_info2']); /// return item details for OrgChart
/* ??? */Route::post('OrgChart', ['as' => 'hamahang.tasks.ugc.desktop.hamahang.org_chart.Test', 'uses' => 'OrgChartController@OrgChart']);
/* ??? */Route::post('show_tasks_custom1', ['as' => 'hamahang.tasks.my_assigned_tasks.CustomTasksPriority', 'uses' => 'MyAssignedTaskController@ShowCustomMyAssignedTasks']); /// search tasks in priority
/* ??? */Route::post('show_tasks_states', ['as' => 'hamahang.tasks.filter_states', 'uses' => 'TaskController@show_tasks_custom_for_states']); /// search tasks in states
/* ??? */Route::post('task_details', ['as' => 'hamahang.tasks.details', 'uses' => 'MyAssignedTaskController@task_info']); /// return item details for OrgChart
