...
/* ??? */Route::post('calendar', ['as' => 'hamahang.calendar.data', 'uses' => 'CalendarController@calendar']);
/* ??? */Route::post('deleteCalendar', ['as' => 'hamahang.calendar.deleteCalendar', 'uses' => 'CalendarController@deleteCalendar']);
/* ??? */Route::post('personalSearchEvent', ['as' => 'hamahang.calendar.personalSearchEvent', 'uses' => 'CalendarController@personalEventSearch']);
/* ??? */Route::post('getPermissionCalendar', ['as' => 'hamahang.calendar.getPermissionCalendar', 'uses' => 'CalendarController@getPermissionCalendar']);
/* ??? */Route::post('change_calendar', ['as' => 'hamahang.calendar.change_calendar', 'uses' => 'calendarController@change_calendar']);
/* ??? */Route::post('getCalendarInfo', ['as' => 'hamahang.calendar.getCalendarInfo', 'uses' => 'CalendarController@getCalendarInfo']);
