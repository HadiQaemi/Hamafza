...
/* ??? */Route::get('ScheduleTaskCopy', ['as' => 'ugc.desktop.hamahang.tasks.my_assigned_tasks.schedule_task_copy', 'uses' => 'TaskController@ScheduleTaskCopy']);
/* ??? */Route::get('gantt', ['as' => 'ugc.desktop.hamahang.tasks.my_assigned_tasks.Gantt', 'uses' => 'TaskController@GanttChart']);
