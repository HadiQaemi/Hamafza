...
Route::get('AllList', ['as' => 'pgs.desktop.hamahang.tasks.my_tasks.list', 'uses' => 'MyTaskController@ListAllTask', 'middleware' => ['dynamic_permission:pgs.desktop.hamahang.tasks.my_tasks.list']]);
Route::get('transcripts', ['as' => 'pgs.desktop.hamahang.tasks.my_tasks.transcripts_list', 'uses' => 'MyTaskController@get_transcripts', 'middleware' => ['dynamic_permission:pgs.desktop.hamahang.tasks.my_tasks.list']]);
