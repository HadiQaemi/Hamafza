...
//                    dd($blocks);
                    ...
                    {
                        $view .= str_ireplace('src="tinymce', 'src="https://hamafza.ir/tinymce', str_ireplace('src="FileManager', 'src="https://hamafza.ir/dFileManager', str_ireplace('src="../../', 'src="/', $block->content)))."<br />\r\n";
                    }
                }
