...
class task_assignments extends Model
{
    ...
    public static function create_task_assignment($employee_id,$is_response , $task_id, $transferer_to = null, $transmitter_id = null, $reject_description = null, $assigner_id = -1, $uid = -1)
    {
