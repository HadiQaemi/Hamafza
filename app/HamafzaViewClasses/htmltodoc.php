...
class htmltodoc
{
    ...
    function getHeader()
    {
        $return = <<<EOH
			...
			<style>
                                {mso-generic-font-family:"B Nazanin";}
                                @page WordSection1
	{size:595.3pt 841.9pt;
	margin:72.0pt 72.0pt 72.0pt 72.0pt;
	mso-header-margin:35.4pt;
	mso-footer-margin:35.4pt;
	mso-paper-source:0;direction:rtl;}
			<!--
			 /* Font Definitions */
			@font-face
			...
			p.MsoNormal, li.MsoNormal, div.MsoNormal
				...
				font-family:"B Nazanin";
				mso-fareast-font-family:"B Nazanin";}
			p.small
				{mso-style-parent:"";
				margin:0in;
				margin-bottom:.0001pt;
...
EOH;
    ...
    function createDocFromContent($Content, $file, $download = false)
    {
