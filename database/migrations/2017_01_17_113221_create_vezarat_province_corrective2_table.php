...
class CreateVezaratProvinceCorrective2Table extends Migration {
	...
	public function up()
	{
		Schema::create('vezarat_province_corrective2', function(Blueprint $table)
		{
	...
	{
		Schema::dropIfExists('vezarat_province_corrective2');
	}
