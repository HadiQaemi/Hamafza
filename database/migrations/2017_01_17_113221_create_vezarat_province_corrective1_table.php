...
class CreateVezaratProvinceCorrective1Table extends Migration {
	...
	public function up()
	{
		Schema::create('vezarat_province_corrective1', function(Blueprint $table)
		{
	...
	{
		Schema::dropIfExists('vezarat_province_corrective1');
	}
