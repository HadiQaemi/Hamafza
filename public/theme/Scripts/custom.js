...
$(document).on("click", "#add_job", function () {
    ...
    $('#staff_job_list').append(
        ...
        '   <div class="col-xs-1">' + (parseInt(length) + 1) +'</div>\n' +
        '   <div class="col-xs-4"><input type="hidden" name="staff_job_corp[]" value="' + $('#staff_job_corp').val() + '">' + $('#staff_job_corp').val() + '</div>\n' +
...
$(document).on("click", "#staff_add_edu", function () {
    length = $("#staff_edu_list > .col-xs-12").length;
    $('#staff_edu_list').append(
        '<div class="col-xs-12 noRightPadding noLeftPadding">\n' +
        '   <div class="col-xs-1">' + (parseInt(length) + 1) +'</div>\n' +
        '   <div class="col-xs-3"><input type="hidden" name="staff_edu_uni[]" value="' + $('#staff_edu_uni').val() + '">' + $('#staff_edu_uni').val() + '</div>\n' +
    ...
    $(document).on("click", ".ful-scrn", function (e) {
        ...
        }else if(rel ==2)
        {
            ...
            if ($(".first-fix-box .ful-scrn span").hasClass("icon-nim-safhe"))
            {
                ...
                $('.div_groups_task.state_container').css('height','55vh');
                $('#base_items_div').css('height','80vh');
                $('#priority_content_area').css('height','80vh');
                // $('#base_items_div').css('height','55vh');
            }
            else{
                $(".first-fix-box .ful-scrn span").addClass("icon-nim-safhe");
                ...
                $('.div_groups_task.state_container').css('height','75vh');
                $('#base_items_div').css('height','90vh');
                $('#priority_content_area').css('height','85vh');
            }
            //alert($('#pcol_32').html());
            if ($("#new-fehrest").hasClass("hidden")){
                $('#new-fehrest').removeClass("hidden");
