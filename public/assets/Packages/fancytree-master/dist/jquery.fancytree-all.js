...
//		tree._triggerNodeEvent("renderNode", ctx);
	...
	nodeRenderStatus: function(ctx) {
		...
		$(node.span).css({paddingRight: indent + "px"});  // #460
...
$.ui.fancytree.registerExtension({
	...
	treeCreate: function(ctx){
		...
		var containerId, cssText, iconSpacingUnit, iconWidthUnit, levelOfsUnit,
			...
			iconSpacing = instOpts.iconSpacing || $dummyIcon.css("margin-right"),
			iconWidth = instOpts.iconWidth || $dummyIcon.css("width"),
			levelOfs = instOpts.levelOfs || $dummyUL.css("padding-right");
