...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "All",
            infos: "نمایش {{ctx.start}} تا {{ctx.end}} از {{ctx.total}} مورد",
            loading: "Loading...",
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></span> <input type=\"text\"" +
            " class=\"{{css.searchField}}\" placeholder=\"جستجو\" /></div></div>",
