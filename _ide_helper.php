 ...
 * Generated for Laravel 5.3.31 on 2017-07-17.
 *
...
namespace Monarobase\CountryList { 
    ...
    class CountryListFacade {
        ...
        {
            return \Monarobase\CountryList\CountryList::getOne($countryCode, $locale);
        }
        ...
        {
            return \Monarobase\CountryList\CountryList::getList($locale, $format);
        }
        ...
        {
            return \Monarobase\CountryList\CountryList::setList($locale, $data);
        }
        ...
        {
            return \Monarobase\CountryList\CountryList::has($countryCode, $locale);
        }
...
namespace  { 
    ...
    class JDateTime extends \App\HamahangCustomClasses\JDateTime {}
